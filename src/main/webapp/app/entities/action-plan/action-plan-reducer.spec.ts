...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIONPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIONPLAN actions', async () => {
      const expectedActions = [
        {
