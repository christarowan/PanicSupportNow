...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONELINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONELINK actions', async () => {
      const expectedActions = [
        {
