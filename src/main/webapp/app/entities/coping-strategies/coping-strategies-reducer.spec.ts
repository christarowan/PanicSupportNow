...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './coping-strategies.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPINGSTRATEGIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPINGSTRATEGIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPINGSTRATEGIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPINGSTRATEGIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPINGSTRATEGIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPINGSTRATEGIES actions', async () => {
      const expectedActions = [
        {
