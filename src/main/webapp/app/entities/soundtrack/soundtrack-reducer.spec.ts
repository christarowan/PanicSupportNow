...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOUNDTRACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOUNDTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOUNDTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOUNDTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOUNDTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOUNDTRACK actions', async () => {
      const expectedActions = [
        {
