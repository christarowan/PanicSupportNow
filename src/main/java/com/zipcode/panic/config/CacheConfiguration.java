package com.zipcode.panic.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zipcode.panic.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zipcode.panic.repository.UserRepository.USERS_BY_EMAIL_CACHE);
